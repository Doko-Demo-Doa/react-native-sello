...
- (void)addKeyboardPassword:(NSString *)keyboardPassword startDate:(double)startDate endDate:(double)startDate key:(LockModel *)key completion:(BLECompletion)completion;
/** 获取锁里面的时间 */
