...
public class TtLockModule extends ReactContextBaseJavaModule implements TTLockCallback {
  ...
  private final static int ACTION_ADD_KEYBOARD_PASSWORD = 0x11 << 7;
  private final static int ACTION_MODIFY_KEYBOARD_PASSWORD = 0x11 << 8;
  ...
  @ReactMethod
  public void modifyKeyboardPassword(int passwordType, String oldPass, String newPass, double startDate, double endDate, String keyJson, Callback callback) {
    mKeyboardPasswordType = passwordType;
    mKeyboardPassword = oldPass;
    mNewKeyboardPassword = newPass;
    mLockSetStartDate = (long) startDate;
    mLockSetEndDate = (long) endDate;
    mLockAction = ACTION_MODIFY_KEYBOARD_PASSWORD;
    mLockOperationCallback = callback;
    saveCurrentKeyObj(keyJson);
    mLockApi.connect(mSelectLock.getLockMac());
  }
  ...
  private void saveCurrentKeyObj(String keyJson) {
    try {
      Type lockDataType = new TypeToken<LockData>() {
      }.getType();
      ...
      switch (mLockAction) {
        ...
        case ACTION_MODIFY_KEYBOARD_PASSWORD:
          mLockApi.modifyKeyboardPassword(
              ...
              mKeyboardPasswordType,
              mKeyboardPassword,
              mNewKeyboardPassword,
              mLockSetStartDate,
              mLockSetEndDate,
